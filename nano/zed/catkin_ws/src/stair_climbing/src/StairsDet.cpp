...
void StairDetection::SD_Start()
{
	...
	d21_avg.assign(3,0);
	std_msgs::Int32 d21,cnt21,d4,d5,d7,d;
	...
	while(ros::ok())
	{
		...
		d21_temp=((depthMD(mid_x-100,mid_y+25)+depthMD(mid_x-100,mid_y+30)+depthMD(mid_x-100,mid_y+20))/3-(depthMD(mid_x+100,mid_y+25)+depthMD(mid_x+100,mid_y+30)+depthMD(mid_x+100,mid_y+20))/3);
